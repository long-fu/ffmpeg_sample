...
int ReadBinFile(const string& fileName, void*& data, uint32_t& size)
{
    struct stat sBuf;
...
// int ReadJpeg(ImageData& image, const std::string& fileName)
// {
//     uint32_t size = 0;
//     void* buf = nullptr;
...
// int ReadPng(ImageData& image, const std::string& fileName)
// {
//     uint32_t size = 0;
//     void* buf = nullptr;
//     ReadBinFile(fileName, buf, size);
